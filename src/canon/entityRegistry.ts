...
export const CANON_ENTITY_REGISTRY: CanonEntity[] = [
  ...
  { canonicalId: 'tolven-marr', canonicalName: 'Tolven Marr', kind: 'npc', aliases: ['Tolven'], deprecatedAliases: [], source: 'Livro VII.001.1-5 (completo)', status: 'blocker', notes: 'Canônico: nascido em Veyr, ferreiro de profissão. Jogo atual: "Guarda-caminho de Varreth". Papel/profissão ainda não reconciliados — mudar isso toca diálogo e a quest do capítulo 1, fora do escopo desta rodada. Ver CANON_CONFLICTS.md §4 e docs/canon/npcs/tolven-marr.md.' },
