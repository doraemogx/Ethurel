...
export const CANON_ENTITY_REGISTRY: CanonEntity[] = [
  ...
  { canonicalId: 'ynara-voss', canonicalName: 'Ynara Voss', kind: 'origin-character', aliases: [], deprecatedAliases: [], source: 'Livro VI.2', status: 'blocker', notes: 'BLOCKER A: jogo liga a Culto do Selo, cânone liga a Arquivo Vertido. Ver COMPARISON.md.' },
  ...
  { canonicalId: 'mireth-sable', canonicalName: 'Mireth Sable', kind: 'origin-character', aliases: [], deprecatedAliases: [], source: 'Livro VI.4', status: 'blocker', notes: 'BLOCKER B: jogo usa Tecelão do Véu/Arquivo Vertido (par canônico de Asera Morn); cânone é Portadora de Cinza/Culto do Selo. Ver COMPARISON.md.' },
  { canonicalId: 'corwin-thale', canonicalName: 'Corwin Thale', kind: 'origin-character', aliases: [], deprecatedAliases: [], source: 'Livro VI.5', status: 'blocker', notes: 'BLOCKER C: jogo usa Caçador de Fissuras (classe canônica de Kael Orren); cânone é Arauto do Musgo. Origem (Fronteira Partida) já batia. Ver COMPARISON.md.' },
  ...
  // NPCs (Livro VII)
  { canonicalId: 'tolven-marr', canonicalName: 'Tolven Marr', kind: 'npc', aliases: ['Tolven'], deprecatedAliases: [], source: 'Livro VII.001.1-5 (parcial — segredo/relações e rotina/arcos ainda não lidos)', status: 'blocker', notes: 'Nascido em Veyr no cânone; papel dele em Varreth no jogo ainda não foi reconciliado com essa biografia. Ver CANON_CONFLICTS.md §4.' },
];
